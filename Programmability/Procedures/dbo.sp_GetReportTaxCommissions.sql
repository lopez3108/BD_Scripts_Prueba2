...
CREATE PROCEDURE [dbo].[sp_GetReportTaxCommissions] (@AgencyId INT,
...
BEGIN
  ...
  SET @BalanceDetail = (SELECT
    ...
    FROM dbo.fn_GenerateTaxCommissionsInitialReport(@AgencyId, '1985-01-01', @initialBalanceFinalDate))
  ...
  INSERT INTO #Temp
    ...
    SELECT
      *
    FROM [dbo].fn_GenerateTaxCommissionsInitialReport(@AgencyId, @FromDate, @ToDate)
...
--                       'INITIAL BALANCE',
--					   dbo.fn_CalculateTaxCommissionsInitialBalance(@AgencyId, @initialBalanceFinalDate),
--					   NULL,
--					   NULL,
--					   NULL,
--					   NULL
...
--						 WHERE 
--						 dbo.ProviderTypes.Code = 'C04' AND
