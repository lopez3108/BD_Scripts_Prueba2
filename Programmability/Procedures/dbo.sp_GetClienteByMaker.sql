...
CREATE PROCEDURE [dbo].[sp_GetClienteByMaker]
 (
      @MakerId int
    )
AS 
...
SELECT        Clientes.ClienteId, Clientes.UsuarioId, Clientes.Foto, Clientes.FingerPrint, Clientes.Note, Clientes.Doc1Front, Clientes.Doc1Back, Clientes.Doc1Type, Clientes.Doc1Number, Clientes.Doc1Country, Clientes.Doc1State, 
                         ...
                         Users.ZipCode,ZipCodes.State, ZipCodes.City, ZipCodes.County, Users.Address, Users.Lenguage, Users.[User], Countries_1.Name AS Doc2CountryName, Countries.Name AS Doc1CountryName, dbo.fn_GetClientBounced(ClientId) as IsBounced
