...
CREATE PROCEDURE [dbo].[sp_GetNumberPendingsLeaveHours] (@CurrentDate DATETIME, @UserId INT = NULL)
AS
BEGIN
...
WHERE ((SELECT
    dbo.fnu_CalculateLeaveHours(u.UserId, C.CycleDateLeaveHours, NULL))
> 0)
