...
--date 20-06-2025 task 6611 Agregar columna balance al reporte discount details JF

CREATE FUNCTION [dbo].[FN_GetReportDiscountsDetail] (@AgencyId INT, @FromDate DATETIME = NULL, @ToDate DATETIME = NULL)
